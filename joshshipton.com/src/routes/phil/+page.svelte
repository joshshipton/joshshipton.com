...
<div>
  <p class="text-3xl font-bold text-center">JOSH SHIPTON INTERNET WEBSITE</p>
    <p class="text-xl font-semibold text-center py-4">philosophy</p>
...
chad@penguin:~/joshshipton.com/joshshipton.com/src/routes/grappling$ wq
-bash: wq: command not found
chad@penguin:~/joshshipton.com/joshshipton.com/src/routes/grappling$ cat +page.svelte 
<script>
  import { onMount } from "svelte";
  import { enhance } from "$app/forms";
  console.log(`
...
<div>
  <p class="text-3xl font-bold text-center">JOSH SHIPTON INTERNET WEBSITE</p>
    <p class="text-xl font-semibold text-center py-4">grappling</p>
